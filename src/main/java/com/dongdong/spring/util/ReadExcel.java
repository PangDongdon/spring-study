...
public class ReadExcel {
     ...
     * @return
     */
    public  List<UserTest> getExcelInfo(MultipartFile mFile) {
        ...
        System.out.println("ReadExcel工具类类 文件名  :"+fileName);
     ...
     * @throws IOException
     */
    public  List<UserTest> createExcel(InputStream is, boolean isExcel2003) {
        List<UserTest> userList=null;
        try{
            Workbook wb = null;
        ...
        System.out.println("根据excel里面的内容读取客户信息 ReadExcel工具类类 文件名  :");
        System.out.println(userList);
        return userList;
    }
     ...
     * @return
     */
    private List<UserTest> readExcelValue(Workbook wb) {
        // 得到第一个shell
        Sheet sheet = wb.getSheetAt(0);
        // 得到Excel的行数
        this.totalRows = ((Sheet) sheet).getPhysicalNumberOfRows();
        // 得到Excel的列数(前提是有行数)
   ...
   @Test
    public  void test() throws  Exception{
        ...
        System.out.println(getExcelInfo(multipartFile));
    }
}
